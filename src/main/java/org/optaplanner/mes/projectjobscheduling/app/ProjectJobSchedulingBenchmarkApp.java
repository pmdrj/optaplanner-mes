...
import org.optaplanner.mes.common.app.CommonBenchmarkApp;
    ...
    public ProjectJobSchedulingBenchmarkApp() {
        super(
                new ArgOption("template",
                        "org/optaplanner/mes/projectjobscheduling/benchmark/projectJobSchedulingBenchmarkConfigTemplate.xml.ftl", true)
        );
    }
